...
* Guided paper reading and technical discussion
* Introduced basic research workflow in computer vision
* Supported implementation using Python and deep learning frameworks
* Discussed experimental design, evaluation, and result interpretation
...
The micro:bit is a small programmable board designed for educational computing. It allows students to learn fundamental concepts such as input/output control, sensor reading, event-based programming, and simple communication between devices. Through this activity, the student practiced how software instructions can interact with physical hardware in a simple and intuitive way.

**Main activities:**

* Introduced the micro:bit platform and its basic components
* Guided basic programming for input, output, and sensor interaction
* Supported hands-on exercises using LEDs, buttons, and built-in sensors
...
* Supported Python programming practice
* Introduced basic concepts in artificial intelligence
* Discussed academic research workflow
* Guided initial study of computer vision and deep learning topics
...
* Supported academic and research adaptation
* Guided basic programming practice
* Introduced AI and computer vision learning resources
* Discussed research communication and study planning
...
* Loss functions for visual recognition
...
* Boundary mismatch and structural error
* False-positive and false-negative decomposition
...
I am interested in teaching and mentoring students in the following areas:
...
* Image Processing
* Python Programming for AI
* Research Methodology in Computer Vision
* Robust and Reliable Visual Perception
